...
class Page {
    ...
    public static function generateResetButton($scriptName) {
    ...
    public static function generateOptionsForm($scriptName,$buttonText,$options,$reactionID = null) {
        ...
        foreach ($options as $optionName => $currentValue) {
            if($optionName != "c" || getReactionTypeByReactionID($reactionID) == 2) {
                generateOptionField($optionName,$currentValue);
                echo "<br>";
            }
        }
    ...
    public static function generateOptionField($field,$currentValue) {
        switch ($field) {
            case "rn":
            ...
            case "sy":
                ...
                foreach ($systems as $thisSystemID => $thisSystemData) {
                    if ($currentValue == $thisSystemID):
                        echo "<option selected value=\"{$thisSystemID}\">{$thisSystemData['systemName']}</option>";
                    else:
                        echo "<option value=\"{$thisSystemID}\">{$thisSystemData['systemName']}</option>";
                    endif;
                }
                echo "</select></div>";
                break;
    ...
    public static function generatePermalink($options,$reactionID = null,$chain = null) {
